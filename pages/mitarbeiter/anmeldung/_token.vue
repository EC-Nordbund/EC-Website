<template lang="pug">
  v-container(class="page-wrapper")
    v-card
      v-card-title
        h1 Anmeldung für Mitarbeiter für Veranstaltungen
      v-card-text
        v-form(@submit="submit" autocomplete="off")
          ...
          v-checkbox(label="Ich möchte vegetarisches Essen" v-model="data.vegetarisch")
          v-textarea(label="Lebensmittelallergien" v-model="data.lebensmittelallergien" counter="250" @change="lebensmittelallergienEvent" :error-messages="lebensmittelallergienErrors")
