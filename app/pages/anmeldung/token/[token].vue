    ...
    v-col(cols='12')
      v-row
        v-col
          ...
          v-progress-linear.d-none.d-md-block(
            :model-value='loadingStep2 ? 33 : 66',
            height='12',
            striped
          )
      v-row.px-4.px-sm-0
        //- 1. Schritt
        v-col(cols='12', md='4')
          v-card#first-step(color='success', rounded='0', variant='flat')
              ...
              .collapsable-square__content
                .d-flex.flex-column.justify-space-between.fill-height
                  ...
                  .absolute-flex-centered
                    v-avatar(
                      :style='{ maxHeight: avatarMaxSize, maxWidth: avatarMaxSize }',
                      :size='avatarSize',
                      color='rgba(255,255,255,0.16)'
                    )
                      v-icon(color='white', :size='iconSize', :icon='mdiCheck')
        ...
        v-col(cols='12', sm='6', md='4')
          v-card#second-step(
            ...
            rounded='0',
            :color='statusColor',
            :variant='loadingStep2 ? "outlined" : "flat"'
          )
            template(#loader='{ isActive }')
              v-progress-linear(:active='isActive', indeterminate, height='6')
                  ...
                  .absolute-flex-centered
                    v-avatar(
                      ...
                      v-icon(
                        ...
                        color='white',
                        size='96',
                        :icon='isOnWarteliste ? mdiClipboardList : mdiCheckAll'
                      )
        ...
        v-col(cols='12', sm='6', md='4')
          v-card#third-step.fill-height(
            ...
            v-responsive(aspect-ratio='4')
              v-card-title.pb-3.pt-4.d-flex.justify-center
                    ...
                    v-row(
                      ...
                      v-col(cols='3', align='center')
                        v-avatar(size='42', color='warning')
                          v-icon(size='24', color='white', :icon='mdiBell')
...
useHead({ title: 'Anmelde-Bestätigung' })
...
const avatarMaxSize = computed(() =>
  xs.value ? 'calc(100vw * .75)' : 'calc(100vw * .2)',
)
