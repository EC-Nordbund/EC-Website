...
v-container.page-wrapper
  ...
  div(v-if='success')
    ...
    v-alert.text-secondary(type='warning', rounded='0', :icon='mdiInformation')
...
import { ruleLib, useValidation } from '~/composables/validate'
...
export default defineComponent({
  setup() {
    ...
    ;(async () => {
      ...
      if (!valid) {
        router.push('/anmeldung/mitarbeiter/veranstaltung?notvalid=1')
      }
    })()
