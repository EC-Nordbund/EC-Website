...
div
      ...
      v-row
        ...
        v-col(cols="12" md="6")
          v-carousel(cycle, hide-delimiters, show-arrows='hover')
            v-carousel-item(v-for='(img, i) in diashow', :key='i', :src='img')
  ...
  .angle--both-right-right.ec-gradient.before-footer
    v-container
      v-row
        ...
        v-col(cols="12" sm="6")
          ...
          v-btn.mb-4(variant='flat', rounded='0', block, to='/downloads/Dokumente/Karlsminde') Preisliste
        ...
        v-col(cols="12" sm="6")
          ...
          .text-body-1 Web:&nbsp;
            a.text-secondary(href='https://www.ebz-wittensee.de', alt="https://www.ebz-wittensee.de" title="Zur Website" rel="noopener") https://www.ebz-wittensee.de

</template>
<script setup lang="ts">
import karlsmindeImg from '~/assets/img/karlsminde/karlsminde.jpg'
import diashow1 from '~/assets/img/karlsminde/diashow (1).jpg'
import diashow2 from '~/assets/img/karlsminde/diashow (2).jpg'
import diashow3 from '~/assets/img/karlsminde/diashow (3).jpg'
import diashow4 from '~/assets/img/karlsminde/diashow (4).jpg'
import diashow5 from '~/assets/img/karlsminde/diashow (5).jpg'
import diashow6 from '~/assets/img/karlsminde/diashow (6).jpg'
import diashow7 from '~/assets/img/karlsminde/diashow (7).jpg'
import diashow8 from '~/assets/img/karlsminde/diashow (8).jpg'
import diashow9 from '~/assets/img/karlsminde/diashow (9).jpg'
import diashow10 from '~/assets/img/karlsminde/diashow (10).jpg'
import diashow11 from '~/assets/img/karlsminde/diashow (11).jpg'
import diashow12 from '~/assets/img/karlsminde/diashow (12).jpg'
...
useSeoMeta({
  ...
  ogTitle: 'EC-Ferienlager Karlsminde',
  ogDescription:
    'Ein Ort, an dem schon viele unvergessliche Tage verbracht wurden. Egal ob Boot fahren, im Wald spielen oder ... Für jeden ist auf dem Gelände mit spitzdach Bungalows was dabei!',
  twitterTitle: 'EC-Ferienlager Karlsminde',
  twitterDescription:
    'Ein Ort, an dem schon viele unvergessliche Tage verbracht wurden. Egal ob Boot fahren, im Wald spielen oder ... Für jeden ist auf dem Gelände mit spitzdach Bungalows was dabei!',
})
</script>
...
.before-footer {
  margin-bottom: calc(-1px - #{3.492}vw);
}
